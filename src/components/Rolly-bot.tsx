...
export interface RollyBotProps {
  className?: string,
}

export default function RollyBot({ className }: RollyBotProps): ReactElement {
  return (
    <div className={`complexImage${className ? ` ${className}` : ''}`}>
      ...
      <svg className="Shaddow" width="295" height="12" fill="none" viewBox="0 0 295 12" xmlns="http://www.w3.org/2000/svg">
